...
/*QUESTION ONE*/
	/*Use map to create list of item prices*/
		var price_list = items.map(function(item){
		return item.price;});
	/*Use reduce to total item prices*/
...
/*QUESTION THREE TWO METHODS SHOWN*/
...
/*Method Two*/
/*If you don’t add [0], all item details will display*/
//var filter_GBP = items.filter(function(item){
//return item.currency_code == 'GBP';});
//filter_GBP.map(function(item){
...
/*QUESTION FOUR*/
/*Why does undefined appear in the console after the answers are given?*/
	items.forEach(function(item) {
...
/*QUESTION FIVE*/
/*Why does undefined appear in the console after the answers are given?*/
/*console.log(“\n”) returns 2 empty lines; console.log(“\n\n”) returns 3 empty lines; etc.*/
	var material_count = items.filter(function(item){
...
/*QUESTION SIX*/
	...
	console.log(bySeller.length+' were made by their sellers');
